...
class Predictor:
    def __init__(self):
        self.model_name = "version 11"
        self.model_ver = "1_1_1"
        self.model_desc = "Model su dung nhan DPD30, model bo sung cac mo hinh: DecisionTreeClassifier, AdaBoostClassifier"
        self.model = None
