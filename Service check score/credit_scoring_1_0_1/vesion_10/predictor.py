...
try:
    from app_submit_model.model_versions.credit_scoring_1_0_10 import features_encoding as fe
except:
    from app_submit_model.model_versions.credit_scoring_tmp import features_encoding as fe

class Predictor:
    def __init__(self):
        self.model_name = "version 10"
        self.model_ver = "1_0_10"
        self.model_desc = "test model part 15+4"
        self.model = None
