...
class Predictor:
    def __init__(self):
        self.model_name = "version 5"
        self.model_ver = "1_0_5"
        self.model_desc = "model soft vosting chi su dung XGBoost (he so Soft vosting là (0,0,0,1) va Su dung thu label DPD, FPD (Day là mo hinh su dung DPD30)"
        self.model = None
