...
####################################################
try:
    from app_submit_model.model_versions.credit_scoring_1_0_8 import features_encoding as fe
except:
    from app_submit_model.model_versions.credit_scoring_tmp import features_encoding as fe
###################################################
...
class Predictor:
    def __init__(self):
        self.model_name = "version 3"
        self.model_ver = "1_0_3"
        self.model_desc = "model soft vosting chi su dung XGBoost (he so Soft vosting là (0,0,0,1))"
        self.model = None
...
#     import json
#     x = json.load(open('x.json', 'r', encoding='utf8'))
#     p = Predictor()
#     p.load_model('model.pkl')
#     pred,  loanbriefid= p.predict_proba([x])
#     print(pred)
#     print(loanbriefid)
#
