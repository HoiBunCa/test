...
class Predictor:
    def __init__(self):
        self.model_name = "version 9"
        self.model_ver = "1_0_9"
        self.model_desc = "Model ap dung mot them 2 mo hinh la Decision tree va AdaBoosting, he so soft la [2, 1, 1, 4, 1, 1]"
        self.model = None
